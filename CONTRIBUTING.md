...
3. **Configure your LLM provider**
   ...
   > **Personal note:** I've been using `anthropic/claude-opus-4-5` locally and it works well for most skill development tasks. Swap in whatever you have access to.
